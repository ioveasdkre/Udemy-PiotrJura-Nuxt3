...
import type { API } from '../projextLiistDto';

// console.log(await $fetch('https://api.github.com/users/piotr-jura-udemy/repos'));

// nuxt 提供的語法糖
// console.log(await useFetch('https://api.github.com/users/piotr-jura-udemy/repos'));

const { error, pending, data } = await useFetch<Array<API>>(
